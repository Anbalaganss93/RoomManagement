...
import com.roommanagement.MonthlyDetailActivity;
 ...
 */
public class MonthlyDetailAdapter extends RecyclerView.Adapter<MonthlyDetailAdapter.MyHolder> {
    Context context;
    ArrayList<DailyModel> arrayList;
    private Typeface typeface, typefacebold;

    public MonthlyDetailAdapter(MonthlyDetailActivity mActivity, ArrayList<DailyModel> dailylist) {
    ...
    public MyHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.monthlydetail_layout, parent, false);
