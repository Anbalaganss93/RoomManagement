...
public class BoldButtonFonts extends AppCompatButton {

    public BoldButtonFonts(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        init(attrs);
    }

    public BoldButtonFonts(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(attrs);

    }

    public BoldButtonFonts(Context context) {
        super(context);
        init(null);
    }
